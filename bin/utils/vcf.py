...
class vcf():
    ...
    def bcftools_pre_process(self, vcf, output_vcf) -> None:
        ...
        cmd = (
            f"nextflow-bin/bcftools-1.18/bcftools +split-vep --columns - -a CSQ -Ou -p 'CSQ_' -d {vcf} | "
            f"nextflow-bin/bcftools-1.18/bcftools annotate -x INFO/CSQ -o {output_vcf}"
        )
